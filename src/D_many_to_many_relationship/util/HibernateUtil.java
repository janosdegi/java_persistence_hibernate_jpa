...
package D_many_to_many_relationship.util;
...
//            System.out.println("---------------------------------------------");
            ...
            StandardServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().configure("/D_many_to_many_relationship/util/hibernate.cfg.xml").build();

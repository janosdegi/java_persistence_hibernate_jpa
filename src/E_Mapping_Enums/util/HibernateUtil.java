...
//            System.out.println("---------------------------------------------");
            ...
            StandardServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().configure("/E_Mapping_Enums/util/hibernate.cfg.xml").build();

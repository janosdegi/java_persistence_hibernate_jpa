...
package B_one_to_many_relationship.util;
...
//            System.out.println("---------------------------------------------");
            ...
            StandardServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().configure("/B_one_to_many_relationship/util/hibernate.cfg.xml").build();

...
//            System.out.println("---------------------------------------------");
            ...
            StandardServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().configure("/A_firstlesson/util/hibernate.cfg.xml").build();

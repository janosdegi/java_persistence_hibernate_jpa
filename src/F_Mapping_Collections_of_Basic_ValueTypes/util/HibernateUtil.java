...
package F_Mapping_Collections_of_Basic_ValueTypes.util;
...
//            System.out.println("---------------------------------------------");
            ...
            StandardServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().configure("/F_Mapping_Collections_of_Basic_ValueTypes/util/hibernate.cfg.xml").build();
